    ...
    <NavbarContainer>
      ...
      {isOpen && (
        <MobileMenu isOpen={isOpen}>
          ...
          <Navlink to="/" onClick={() => setIsOpen(!isOpen)}>Plases to stay</Navlink>
          <Navlink to="/" onClick={() => setIsOpen(!isOpen)}>Contact</Navlink>
          <Navlink to="/" onClick={() => setIsOpen(!isOpen)}>Blogs</Navlink>
          <div style={{
            flex: 1,
            display: "flex",
            gap: "12px",
      ...
      <NavItems>
        ...
        <Navlink to="/properties">Plases to stay</Navlink>
